            ...
            if (enc != null && enc.getForm() != null &&
                ...
                for (Obs o : obs) { // Loop through the obs and compose Appointment object for Bahmni
                    ...
                    if(o.getConcept().getUuid().equals(NEXT_DRUG_REFILL_APPOINTMENT_DATE_CONCEPT_UUID)) {
                        ...
                        Date refillStartDateTime = DateUtil.convertToDate(dateFormat.format(o.getValueDatetime()).concat("T06:00:00.0Z"), DateUtil.DateFormatType.UTC);
                    ...
                    if(o.getConcept().getUuid().equals(NEXT_CLINICAL_APPOINTMENT_DATE_CONCEPT_UUID) ) {
                        ...
                        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
                        Date nextApptStartDateTime = DateUtil.convertToDate(dateFormat.format(o.getValueDatetime()).concat("T06:00:00.0Z"), DateUtil.DateFormatType.UTC);
